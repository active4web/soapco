...
?>
        ...
        <meta content="لوحة تحكم موقع السوابوكى" name="description" />
		...
		<?php
		$site_favicon=$this->session->userdata('site_favicon');
		?>
        <link rel="shortcut icon" href="<?=$url;?>uploads/site_setting/<?= $site_favicon;?>" type="image/x-icon" />
