...
class M_image extends CI_Model{
    ...
    function __construct() {
        ...
        $this->uploads_path = realpath(APPPATH . '../uploads/files');

        $this->original_path = realpath(APPPATH.'../uploads/customers');

        $this->size1_path = realpath(APPPATH.'../uploads/size1');

        $this->size2_path = realpath(APPPATH.'../uploads/size2');

        $this->size3_path = realpath(APPPATH.'../uploads/size3');

        $this->size4_path = realpath(APPPATH.'../uploads/size4');

        $this->slider_path = realpath(APPPATH.'../uploads/slider');
