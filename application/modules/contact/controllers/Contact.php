...
$this->load->view('contact',$datacontent);
...
$main_msg.="اسم الشركة".":".$com."<br>";
$main_msg.="الرسالة".":".$message."<br>";
$logo=DIR."uploads/site_setting/$logo"		;	

		 $subject = "رسالة جديدة من موقع سوابوكى SOPACO  ";
		 $mail_message= "<br>";
		 $mail_message.=
			 ...
			 <table cellspacing='0' cellpadding='0' width='600' class='w320'>
			   <tr>
				 <td style='padding:5px 0 25px' class='free-text headerlgb1'>
				   &copy; جميع الحقوق محفوظة لدى شركة <a href='https://soapco-sa.com/'> سوابوكى-SOAPCO   </a>  <br />
				  <br /><br />
				 </td>
			   </tr>
			 </table>
