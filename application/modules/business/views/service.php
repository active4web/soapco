		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumb">
					...
					<li ><a href="<?= DIR?>business" style="color:#fff;">Business</a></li>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<p><?= $data_products->details;?></p>
								...
								<div class="">
                        <img src="<?= DIR_DES_STYLE?>business/<?= $data_products->img;?>" class="rounded float-left img_business" style="width:100%">
