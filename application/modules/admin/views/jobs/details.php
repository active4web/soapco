			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/jobs/';?>">الوظائف المتاحة</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
							<span>تعديل</span>
												...
												<div class="portlet box blue ">
													...
													<div class="portlet light bordered form-fit">
														<div class="portlet-body form">
															...
															<form action="<?php echo $url?>admin/jobs/edit_action" class="form-horizontal form-bordered"
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block">الوظيفة</span>
																			<input name="title" id="title" value="<?=$services_type->title;?>" type="text" placeholder="الوظيفة" class="form-control" required>
