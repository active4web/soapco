						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												<?php if($result_amount>0){
													...
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton"> إضافة وظيفة
									...
									<form action="<?=$url?>admin/jobs/delete" method="POST" id="form">
									<div>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/jobs/details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/jobs/delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/jobs/add");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/jobs/delete");
	});
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/jobs/check_view_countries") ?>',
                type: 'POST',
                data: data,				
