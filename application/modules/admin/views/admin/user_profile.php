...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="<?=$url;?>admin/update_profile" method="post">
															<div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="الاسم الاول" value="<?php echo $data_admin->fname;?>" class="form-control" name="fname"> 
															</div>
                                                           
                                                            <div class="form-group">
                                                                <label class="control-label">الإسم الاخير</label>
                                                                <input type="text" placeholder="الإسم الاخير" value="<?php echo $data_admin->lname;?>" class="form-control" name="lname"> </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                        <img src="<?=$url;?>uploads/site_setting/<?=$this->session->userdata('myimg')?>" alt=""> </div>
                                                                    <div>
                                                    ...
                                                    <div class="tab-pane" id="tab_1_3">
                                                        <form action="<?=$url;?>admin/editpassword" id="form" method="post">
                                                            ...
                                                            <div class="margin-top-10">
                                                            <input type="button" value="حفظ كلمة المرور" class="btn green mainbutton" id="cvcx">
		...
		<input type="hidden" value="0" id="idold">
			<input type="hidden" value="0" id="idrep">
        <!-- END CONTAINER -->
        <!-- BEGIN FOOTER -->
    ...
    <script type="text/javascript">
        $('#newpass').focusout(function(e){
            ...
            $.ajax({
			    ...
			    //alert(data);
                    if(data==1){$("#oldpa").hide();$('#cvcx').prop("type", "button");$("#idrep").val(2)}
			        else {$("#oldpa").show();$('#cvcx').prop("type", "button");$("#idrep").val(0)}
		        }
