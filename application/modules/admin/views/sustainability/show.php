							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">Sustainability</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?=$url?>admin/sustainability/delete" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												$image=$data->img;
												$img=$url."uploads/sustainability/".$image; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/sustainability/edit?id=<?=$data->id;?>"><i class="fa fa-pencil"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/sustainability/delete?id_products=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= base_url()?>admin/sustainability/add");
    });

	$(".delbutton").click(function(e) {
        window.location.assign("<?= base_url()?>admin/sustainability/delete");
	});
});
</script>
<script>
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/sustainability/active") ?>',
		type: 'POST',
		data: data,				
