...
<head>
<meta charset="utf-8">
<title>تعديل المسمى الوظيفى</title>
		...
		<div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">تعديل المسمى الوظيفى</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        <div class="portlet box blue ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>تعديل المسمى الوظيفى</div>
                                            </div>
                                                    ...
                                                    <div class="form-body">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block">المسمى</span>
                                                                <input type="text" id="txt" required placeholder="المسمى"  value="<?=$data->name?>" class="form-control" name="name">
