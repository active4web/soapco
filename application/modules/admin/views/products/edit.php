												...
												<div class="portlet box blue ">
													...
													<div class="portlet light bordered form-fit">
														...
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $url?>admin/business/edit_action" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
																<div class="form-body">
																<input type="hidden" name="id" value="<?=$id;?>">
																	...
																	<div class="col-md-10">
																		<div class="fileinput fileinput-new" data-provides="fileinput">
																						...
																						<img src="<?=base_url();?>uploads/business/<?php echo $img?>" alt="" />
																						</div>
